...
@onready var bot_sprite: TextureRect = $Room/BotSprite
@onready var level_label: Label = $Room/TopBar/LevelLabel
@onready var xp_bar: ProgressBar = $Room/TopBar/XPBar
@onready var energy_bar: ProgressBar = $Room/Stats/EnergyBar
@onready var focus_bar: ProgressBar = $Room/Stats/FocusBar
@onready var mood_bar: ProgressBar = $Room/Stats/MoodBar
@onready var tidbit_bubble: Label = $Room/TidbitBubble
@onready var xp_tick: Label = $Room/XPTick
@onready var campaign_btn: Button = $Room/CampaignButton
...
func _ready() -> void:
	...
	$Room/Buttons/FeedButton.pressed.connect(_on_care.bind("feed"))
	$Room/Buttons/PetButton.pressed.connect(_on_care.bind("pet"))
	$Room/Buttons/PlayButton.pressed.connect(_on_care.bind("play"))
